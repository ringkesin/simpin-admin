<div>
    ...
    <x-elements.button wire:navigate :href="route('main.tagihan.list')" :variant="'primary'" :style="'outlined'" :type="'link'" class='mb-6'>
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="p-6 bg-white border rounded-lg shadow-lg border-slate-200">
            ...
            <div class='px-4 py-4 mb-6 border rounded bg-slate-50 border-slate-200'>
                <div class="flex justify-between gap-2">
                    <h2 class="font-semibold text-slate-800 dark:text-slate-100">Export Tagihan</h2>
                </div>
            </div>
        ...
        <div class="p-6 bg-white border rounded-lg shadow-lg border-slate-200">
            ...
            <div class='px-4 py-4 border rounded bg-slate-50 border-slate-200'>
                <div class="flex justify-between gap-2">
                    <h2 class="font-semibold text-slate-800 dark:text-slate-100">Import Tagihan</h2>
                    <div>
