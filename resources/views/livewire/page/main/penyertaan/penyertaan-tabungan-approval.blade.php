<div>
    ...
    <x-elements.button wire:navigate :href="route('main.penyertaan.list')" :variant="'primary'" :style="'outlined'" :type="'link'" class='mb-6'>
    ...
    <div class="p-6 mb-6 bg-white border rounded-lg shadow-lg border-slate-200">
        <h4 class='mb-6 text-lg font-bold'>Detail Request Penyertaan</h4>
        <hr class='mb-6' />
        <div class="grid grid-cols-2">
            <div>
                ...
                <x-elements.detail label="Jumlah">Rp {{ number_format($data->jumlah) }}</x-elements.detail>
            </div>
            <div>
    ...
    <div class="p-6 mb-6 bg-white border rounded-lg shadow-lg border-slate-200">
        ...
        <hr class='mb-6' />
        @if($data->status_penyertaan !== 'DISETUJUI')
            ...
            <div class="grid grid-cols-12 gap-10 mb-2">
                <div class="col-span-12 md:col-span-6">
                    ...
                    <div class="grid items-center grid-cols-12 gap-4 mb-4">
                        ...
                        <div class="col-span-12 md:col-span-8">
                            <div class="col-span-12 md:col-span-8">
                                <x-form.input class="w-full" type="date" name="penyertaan_date" wire:model.lazy="penyertaan_date"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid items-center grid-cols-12 gap-4 mb-4">
                        ...
                        <div class="col-span-12 md:col-span-8">
                            <div class="col-span-12 md:col-span-8">
                                <x-form.select-single name="status_penyertaan" wire:model.lazy="status_penyertaan" class="w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div>
                ...
                <x-elements.detail label="Jumlah Disetujui">Rp {{ number_format($data->jumlah) }}</x-elements.detail>
                <x-elements.detail label="Tanggal Penyertaan">{{ date('d F Y', strtotime($data->penyertaan_date)) }}</x-elements.detail>
