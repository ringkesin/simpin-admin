    ...
    <div class="p-6 bg-white border rounded-sm shadow-lg border-slate-200">
        ...
        <div class='px-4 py-4 mb-6 border rounded bg-slate-50 border-slate-200'>
            <div class="flex justify-between gap-2">
                <div>
                    <x-elements.button wire:navigate :href="route('user.list')" :variant="'success'" :style="'outlined'" :type="'link'">
                ...
                <div>
                    ...
                    <x-elements.button wire:navigate :href="route('user.edit', $id)" :variant="'secondary'" :style="'outlined'" :type="'link'">
        ...
        <div class="mt-5">
            ...
            <x-elements.detail label="Profile photo">
                @php
                    $pp = ($loadData['profile_photo_path'] != 'avatar/blank-avatar.png') ? \Illuminate\Support\Facades\Storage::disk('s3')->temporaryUrl($loadData['profile_photo_path'], now()->addMinutes(1)) : asset('assets/'.$loadData['profile_photo_path']);
                @endphp
