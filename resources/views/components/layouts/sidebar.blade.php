            ...
            <nav class="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                <div class="flex flex-col flex-wrap w-full px-2 pb-0 hs-accordion-group" data-hs-accordion-always-open>
                    <ul class="space-y-1">
                        ...
                        <li>
                            <a class="flex items-center gap-x-3 py-2 px-2.5 {{$menu_code == 'dashboard' ? 'bg-gray-100' : ''}} text-sm text-gray-700' rounded-lg hover:bg-gray-100 dark:bg-neutral-700 dark:text-white" href="{{route('dashboard')}}">
                        ...
                        <li>
                            <a class="flex items-center gap-x-3 py-2 px-2.5 {{$menu_code == 'tabungan' ? 'bg-gray-100' : ''}} text-sm text-gray-700' rounded-lg hover:bg-gray-100 dark:bg-neutral-700 dark:text-white" href="{{route('tabungan.list')}}">
                        ...
                        <li>
                            <a class="flex items-center gap-x-3 py-2 px-2.5 {{$menu_code == 'tagihan' ? 'bg-gray-100' : ''}} text-sm text-gray-700' rounded-lg hover:bg-gray-100 dark:bg-neutral-700 dark:text-white" href="{{route('tagihan.list')}}">
                        ...
                        <li class="hs-accordion" id="master-accordion">
                            ...
                            <div id="master-accordion-collapse-1" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 {{$menu_code == 'master-anggota' ? '' : 'hidden'}}" role="region" aria-labelledby="master-accordion">
                                <ul class="pt-1 space-y-1 ps-7">
                                    <li>
                                        <a class="flex items-center gap-x-3 py-2 px-2.5 text-sm {{$menu_code == 'master-anggota' ? 'bg-gray-100 pl-5' : ''}} text-gray-700 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:text-neutral-300 dark:focus:text-neutral-300" href="{{route('master.anggota.list')}}">
                                        Anggota
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <li>
                            <a class="flex items-center gap-x-3 py-2 px-2.5 {{$menu_code == 'user' ? 'bg-gray-100' : ''}} text-sm text-gray-700' rounded-lg hover:bg-gray-100 dark:bg-neutral-700 dark:text-white" href="{{route('user.list')}}">
